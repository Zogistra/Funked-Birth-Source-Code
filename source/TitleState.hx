...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		logoBl.frames = Paths.getSparrowAtlas('logo_funked');ogoBl.frames = Paths.getSparrowAtlas('logo_funked');
		#end
		
		logoBl = new FlxSprite(350,-20);
		logoBl.frames = Paths.getSparrowAtlas('logo_funked');logoBl.frames = Paths.getSparrowAtlas('logo_funked');
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('An FNF Christmas Mod'); // credTextShit.text += '\nFunkin';
